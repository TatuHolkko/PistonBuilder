...
public class Program : MyGridProgram
{
    ...
    const int areaWidth = 17,areaHeight = 17,numHorizontalPistons = 2,numVerticalPistons = 2,debugLCDSurfaceIndex = 0,mapLCDSurfaceIndex = 1,welderSize = 1;

    // Vertical total height limits, will be divided equally among vertical pistons
    const float ceilingHeight = 20f,floorHeight = 2.5f,cubeSize = 2.5f,retractedPistonTotalLength = 2 * cubeSize + 0.159f,verticalPistonVelocity = 1f,horizontalPistonVelocity = 1f,maxZ = (ceilingHeight - floorHeight) / cubeSize; // meters

    // Naming conventions
    const string namePrefix = "[BP] ",pistonNameBase = "Pist: ",hingeNameBase = "Hing: ",lightNameBase = "Lght: ",sensorNameBase = "Sens: ",topTag = "T",bottomTag = "B",leftTag = "L",rightTag = "R",verticalTag = "V",horizontalTag = "H",baseTag = "B",welderTag = "W",welderName = "Welder",debugLCDBlockName = "Control Seat",mapLCDBlockName = "Control Seat"; // maximum welder Z height in blocks
    enum Corner
    {
        TopLeft,
        TopRight,
    ...
    Dictionary<Corner, List<IMyPistonBase>> horizontalPistonLists = new Dictionary<Corner, List<IMyPistonBase>>(),verticalPistonLists = new Dictionary<Corner, List<IMyPistonBase>>();
    Dictionary<Corner, IMyMotorStator> baseHinges = new Dictionary<Corner, IMyMotorStator>(),welderHinges = new Dictionary<Corner, IMyMotorStator>();
    ...
    IMyTextSurface mapScreen,pbScreen;
    ...
    float welderX = -1,welderTargetX = -1; // blocks from top left corner
    float welderY = -1,welderZ = -1f,welderTargetY = -1,welderTargetZ = -1f,taskTimeLeft = 0f; // blocks from top left corner

    bool heightScanInProgress = false;
    bool scanDownInProgress = false,safetyLock = true;
